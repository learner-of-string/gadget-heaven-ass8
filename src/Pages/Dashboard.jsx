...
const Dashboard = ({ defaultTabValue = "cart" }) => {
    return (
        <div>
            <div>
                <Tabs defaultValue={defaultTabValue}>
                    <div className="bg-purple-600 py-8 px-10 md:px-60 space-y-5">
                        ...
                        <div className="flex justify-center items-center">
                            <TabsList className="bg-purple-600 border border-white rounded-full p-0">
                                <TabsTrigger
                                    value="cart"
                                    className="bg-purple-600 text-white rounded-full data-[state=active]:bg-white data-[state=active]:text-purple-600 px-5 py-4 font-bold text-sm md:text-xl"
                                >
                                    Cart
                                </TabsTrigger>
                                <TabsTrigger
